                  ...
                  {item?._joinData?.extras?.map((i) => {
                    return (
                      ...
                      >
                        ...
                        <Text style={{color: colorScheme == 'dark' ? COLORS.black : COLORS.dark,}}>{i.option}</Text>
                        <Text style={{ width: 20, fontWeight: "700",color: colorScheme == 'dark' ? COLORS.black : COLORS.dark, }}>
                          {i.price}
                        </Text>
                      </View>
                    );
