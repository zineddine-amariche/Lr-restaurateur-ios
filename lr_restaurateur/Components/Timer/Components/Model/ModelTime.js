    ...
    <UseModelTimer transparent visible={visible}>
      ...
      <View style={styles.body}>
        <TouchableOpacity
          ...
          onPress={() => {
             dispatchClosingRestaurant(dispatch, configHead, {time:15},close);
            ActiveTimer(900);
            startTimer(dispatch, true);
            settimeLeft(900)
          }}>
        ...
        <TouchableOpacity
          style={styles.timeChose}
          onPress={() => {
            dispatchClosingRestaurant(dispatch, configHead, {time: 30},close);
            ActiveTimer(1800);
             startTimer(dispatch, true);
            settimeLeft(1800)
          }}>
        ...
        <TouchableOpacity
          style={styles.timeChose}
          onPress={() => {
            dispatchClosingRestaurant(dispatch, configHead, {time: 45},close);
            ActiveTimer(2700);
             startTimer(dispatch, true);
            settimeLeft(2700)
          }}>
        ...
        <TouchableOpacity
          style={styles.timeChose}
          onPress={() => {
            dispatchClosingRestaurant(dispatch, configHead, {time: 60},close);
            ActiveTimer(3600);
             startTimer(dispatch, true);
            settimeLeft(3600)
          }}>
