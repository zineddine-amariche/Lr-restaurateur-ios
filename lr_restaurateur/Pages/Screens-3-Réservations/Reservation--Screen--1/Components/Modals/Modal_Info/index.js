...
import Modal from "../ModalValidation";
          ...
          <View style={styles.container}>
            <View style={styles.row}>
              ...
              <Text style={styles.Textbold}>
                ...
                {result_ById?.customer?.lastname}</Text>
            </View>
            <View style={styles.row}>
              <View style={styles.imageBox}>
                <Image source={date} />
